...
4. Fitur-fitur yang harus ada di aplikasi dekstop
    a. Eksport database
	b. Report dari database (Pdf dan SpreadSheet)
	c. User Management :
		c.1 CRUD User
		c.2 User Privilage : Admin, Instruktur, Operator, CommonUser, Executive
	d. File Management : 
	...
	e. Security dan Enskripsi releated dengan file dan user management.
		...
		e.3 Hak akses terhadap data sesuai dengan privilage user.
5. Fitur-fitur yang harus ada di web dashboard
	a. Menghilangkan semua tulisan 'Grafana' menjadi 'Inviris-Dashboard'
